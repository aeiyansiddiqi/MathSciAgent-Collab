...
def graphPrompt(input: str, generate, metadata={}, repeat_refine=0, verbatim=False):
    ...
    "of terms mentioned in the given context. These terms should represent the key concepts as per the context, including well-defined and widely used names of mathematical concepts, structures, operations.\n\n"
    ...
    "   }}\n"
    "]\n"
    "Context: ```A group is a set with an associative binary operation, identity, and inverse.```\n"
    "[\n"
    "   {{\n"
    '       "node_1": "group",\n'
    '       "node_2": "set",\n'
    ...
    "   {{\n"
    '       "node_1": "group",\n'
    '       "node_2": "associative binary operation",\n'
    '       "edge": "includes"\n'
    "   }}\n"
    "]\n"
    "Analyze the text carefully and produce around 10 triplets, making sure they reflect consistent mathematical ontologies.\n"
)
    ...
    USER_PROMPT = (
        ...
        f"\n\nImprove the ontology by renaming nodes to be consistent, academic, and domain-specific."
        " Use standard terminology in AI security and backdoor attack literature."
    )
...
def make_graph_from_text (generate,
    ...
    json_dir = r"/home/Aeiyan/testingNougat/SciAgentMath/graphgenerationInput"
